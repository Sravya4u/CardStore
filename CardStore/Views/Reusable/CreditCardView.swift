 ...
 *  CreditCardView.swift
 *
 *  Represents a view displaying a card item, including a bookmar button, which navigates to BookMark tab
 *  The CreditCardView struct is responsible for passing  card cells to the CreditCardListView
 *
